...
public class Soal2NIMGENAP {
    ...
    public static void main(String[] args) {
        ...
        if(p1 > p2){
            ...
            if (p2 > p3) {
                System.out.printf("Bilangan integer %d lebih besar dari bilangan integer %d dan %d", p2, p3, p1);   
            } else {
                System.out.printf("Bilangan integer %d lebih besar dari bilangan integer %d dan %d", p3, p2, p1);  
            }
        }
    }
}
